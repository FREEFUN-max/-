...
interface IAudioSessionControl2 {
  int NotImpl1(); int NotImpl2(); int NotImpl3(); int NotImpl4(); int NotImpl5(); int NotImpl6(); int NotImpl7(); int NotImpl8(); int NotImpl9(); int NotImpl10(); int NotImpl11();
  [PreserveSig] int GetProcessId(out uint pRetVal);
  int NotImpl12(); int NotImpl13();
}
...
function windowsHelper() {
  ...
  psProc.stderr.on("data", (d) => {
    logger.warn("app-volume", `helper stderr: ${String(d).trim()}`);
  });
